...
<li class="nav-item">
    ...
    <section id="blog-home" class="pt-5 mt-5 container">
        <h2 class="font-weight-bold pt-5">Watch Stories & Style Guides</h2>
        <hr>
    </section>
        ...
        <div class="row">
            <div class="post col-lg-6 col-md-6 col-12 pb-5">
                ...
                <h3 class="text-center font-weight-normal pt-3">
                    The best watches for sesaon sales%.
                </h3>
                <p class="text-center">March 22,2026 </p>
            </div>
            ...
            <div class=" col-lg-12 col-md-12 col-12 pb-5">
                <div class="post-img">
                    <img class="img-fluid w-100
                    " src="images/blog/baneer.jpg" alt="">
                </div>
            </div>
        ...
        <div class="copyright mt-5">
            <div class="row container mx-auto">
                ...
                <div class="col-lg-3 col-md-6 col-12 text-nowrap mb-2">
                    <p>rymo eComm. © 2026. All Rights Reserved.</p>
                </div>
